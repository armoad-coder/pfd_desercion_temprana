# src/routes/datos_electricidad_routes.py
...
from src.utils.features_electricidad import (
    FEATURES_EN_ORDEN_ELECTRICIDAD,
    MATERIAS_EN_ORDEN_ELECTRICIDAD,
)

datos_electricidad_bp = Blueprint(
    "datos_electricidad_bp", __name__, url_prefix="/datos/electricidad"
)
...
# ----------------------------------------------------------
# CARGA MASIVA ELECTRICIDAD
# ----------------------------------------------------------

@datos_electricidad_bp.route("/carga_masiva", methods=["POST"])
def carga_masiva_electricidad():
    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            existente = DatosElectricidadDesercion.query.filter_by(id_alumno=id_alumno).first()
            ...
            # --------------------------------------------------
            # Mapeo materias CSV → atributos del modelo Electricidad
            # --------------------------------------------------
            for materia in MATERIAS_EN_ORDEN_ELECTRICIDAD:
                attr = None

                if materia == "ADMINISTRACION Y MERCADOTECNIA":
                    attr = "admin_mercadotecnia"
                elif materia == "ALGEBRA  II":  # con doble espacio en el CSV
                    attr = "algebra_ii"
                    ...
                    attr = "computacion_i"
                elif materia == "CONVERSION DE ENERGIA ELECTRICA  II":
                    attr = "conversion_energia_ii"
                elif materia == "CONVERSION DE ENERGIA ELECTRICA I":
                    attr = "conversion_energia_i"
                ...
                elif materia == "INSTALACIONES ELECTRICAS II":
                    attr = "instalaciones_electricas_ii"
                elif materia == "INSTALACIONES ELECTRICAS III":
                    attr = "instalaciones_electricas_iii"
                ...
                elif materia == "PROGRAMACION EN LENGUAJES DE COMPUTADORA":
                    attr = "programacion_lenguajes_computadora"
            ...
            if existente:
                ...
                nuevo = DatosElectricidadDesercion(
                    id_alumno=id_alumno,
                    **payload,
                )
        ...
        return jsonify({
            "mensaje": "Carga masiva electricidad completada",
            "creados": creados,
